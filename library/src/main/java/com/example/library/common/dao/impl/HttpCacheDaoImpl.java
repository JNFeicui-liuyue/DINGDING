package com.example.library.common.dao.impl;

import android.content.ContentValues;
import android.database.Cursor;


import com.example.library.common.constant.DbConstants;
...
import com.example.library.util.TimeUtils;
...
public class HttpCacheDaoImpl implements HttpCacheDao {
    ...
    private static ContentValues httpResponseToCV(HttpResponse httpResponse) {
        if (httpResponse == null || Validate.isNull(httpResponse.getUrl())) {
            return null;
        }
        ...
        values.put(DbConstants.HTTP_CACHE_TABLE_CREATE_TIME, TimeUtils.getInatance().getCurrentTimeInString());
