...
public class ViewUtils {
    ...
    /**
     *根据{@link #setListViewHeightBasedOnChildren(ListView)} 设置ListView高度
    ...
    /**
     * 根据{@link #setListViewHeightBasedOnChildren(ListView)} 设置AbsListView高度
     ...
     * 
     * @param parent
     * @param filter 将返回视图类型 Type of views which will be returned.
     * @param includeSubClass 返回的视图集合中，是否要返回试图过滤器的子类的视图 Whether returned list will include views which are subclass of filter or not.
     * @return
     */
