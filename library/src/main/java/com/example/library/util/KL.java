...
public final class KL {
    ...
    public static void d_long_json(String tag,String message, int methodCount) {
        validateMethodCount(methodCount);
        log_long_json(Log.DEBUG, tag, message, methodCount);
    }

    public static void d_json(String tag, String json, String message, int methodCount) {
        validateMethodCount(methodCount);
        log_json(Log.DEBUG, json, tag, message, methodCount);
    }
    ...
    public static void json(String tag, String json, int methodCount) {
        ...
        try {
            if (json.startsWith("{")) {
                ...
                d_json(tag, json, message, methodCount);
                return;
            }
            if (json.startsWith("[")) {
    ...
    private static void log_long_json(int logType, String tag, String message,
                                      int methodCount) {
    ...
    private static void log_json(int logType, String json, String tag, String message,
                                 int methodCount) {
        if (settings.logLevel == LogLevel.NONE) {
            return;
        }
...
//            logContent(logType, tag, json);
            d_long_json(tag, json,settings.methodCount);
            logDivider(logType, tag);
            logContent(logType, tag, message);
