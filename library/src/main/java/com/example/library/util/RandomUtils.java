...
public class RandomUtils {
    ...
    public static String getRandom(String source, int length) {
        return Validate.isNull(source) ? null : getRandom(source.toCharArray(), length);
    }

    /**
     * 得到一个固定长度的随机字符串，原类型为char[]
