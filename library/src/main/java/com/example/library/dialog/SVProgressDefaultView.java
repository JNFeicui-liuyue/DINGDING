...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(R.layout.dialog_svprogressdefault, this, true);
    ...
    public void showInfoWithStatus_String(String string) {
        showBaseStatus_String(string);
    }
    ...
    public void showErrorWithStatus_String(String string) {
    	showBaseStatus_String(string);
    }
    ...
    public void showBaseStatus_String(String string) {
        clearAnimations();
//        ivSmallLoading.setImageResource(res);
        tvMsg.setText(string);
        tvMsg.setPadding(0, 0, 0, 10);
        ivBigLoading.setVisibility(View.GONE);
        circleProgressBar.setVisibility(View.GONE);
//        ivSmallLoading.setVisibility(View.VISIBLE);
        tvMsg.setVisibility(View.VISIBLE);
