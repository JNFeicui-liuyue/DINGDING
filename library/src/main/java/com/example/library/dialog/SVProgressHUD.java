...
public class SVProgressHUD {
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.dialog_svprogresshud, null, false);
    ...
    public static void showInfoWithStatus_String(Context context,String string, SVProgressHUDMaskType maskType) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showInfoWithStatus_String(string);
        getInstance(context).svShow();
        getInstance(context).scheduleDismiss();
    }
