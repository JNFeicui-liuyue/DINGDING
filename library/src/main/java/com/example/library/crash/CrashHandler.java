package com.example.library.crash;
...
//	String login_usn;
	...
	public void init(Context context) {
		...
		path_crash = Environment.getExternalStorageDirectory() + File.separator
...
//		login_usn = sp.getString(LOGIN_USN, "");// 取出保存的用户名
	...
	public void sendPreviousReportsToServer(String upload_url) {
		sendCrashReportsToServer(mContext,upload_url);
	}
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		String time = TimeUtils.getInatance().formatDateDay(new Date(timetamp));
	 ...
	 * @param ctx
	 */
	private void sendCrashReportsToServer(Context ctx,String upload_url) {
	...
	@SuppressLint("HandlerLeak")
	private void postReport(String file,String upload_url) {
...
//		};
		// 提交错误报告
		 endPathString = file;
//		 crashconn = new CrashUploadConn(file,upload_url);
//		 crashconn.start();
