...
public class RegionActivity extends AutoLayoutActivity {
...
//        setListViewHeightBasedOnChildren1(country_lv_countryList);
    ...
    private void setListener() {
        ...
        country_lv_countryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long arg3) {
                ...
                intent.setClass(RegionActivity.this, LoginActivity.class);
    ...
    private void getCountryList() {
        System.out.println("获取国家列表长度===================="+getResources().getIntArray(R.array.country_list_ch).length);
        String[] countryList = getResources().getStringArray(R.array.country_list_ch);
