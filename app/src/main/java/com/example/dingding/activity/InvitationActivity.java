...
public class InvitationActivity extends AutoLayoutActivity {

    private ActivityUtils mActivityUtils;

    @Bind(R.id.actionbar_invitation)HMActionBar mHMActionBar;
    ...
    private  void setActionBar(){
        mHMActionBar.setLeftText("邀请");
        mHMActionBar.setViewOccur();
        mHMActionBar.setRightImageResource(R.drawable.ic_more_pop);
